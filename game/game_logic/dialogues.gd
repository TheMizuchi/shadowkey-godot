...
var dialogues = { }
var dialoguelines: Dictionary[int, DialogueLine] = { }
var responses = { }
...
## Add a new dialog to the dialog map at the index id
func add_dialogue_line(id, text):
	var dialogueline = DialogueLine.new(text)
	dialoguelines[id] = dialogueline


## Add a new dialog to the response map at the index id
func add_response(id, text):
	var response = Response.new(text)
	responses[id] = response


## Add a new dialog to the general map at the index id
#TODO change it to the form : func add_dialogue(id, functions, arguments):
#WTF is this function doing? add it the quest line? awful method
...
## Add all dialogs in the game
#TODO add type in the json file to parse it more quickly
...
## Class containing just the dialog
class DialogueLine:
	var text: String = ""
...
## Class containing just the response
class Response:
	var text: String = ""
